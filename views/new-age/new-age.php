...
<head>
	...
	<link href="../assets/vendor/device-mockups/device-mockups.min.css" rel="stylesheet">
						...
						<div class="device-mockup iphone6_plus portrait white">
							<div class="device">
								<div class="screen">
									...
									<img src="../assets/img/new-age/demo-screen-1.jpg" class="img-responsive" alt="">
								</div>
								<div class="button">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					...
					<div class="badges">
						<a class="badge-link" href="#"><img src="../assets/img/new-age/google-play-badge.svg" alt=""></a>
						<a class="badge-link" href="#"><img src="../assets/img/new-age/app-store-badge.svg" alt=""></a>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="device-container">
						<div class="device-mockup iphone6_plus portrait white">
							<div class="device">
								<div class="screen">
									<!-- Demo image for screen mockup, you can put an image here, some HTML, an animation, video, or anything else! -->
									<img src="../assets/img/new-age/demo-screen-1.jpg" class="img-responsive" alt=""> </div>
								<div class="button">
									<!-- You can hook the "home button" to some JavaScript events or just remove it -->
								</div>
							</div>
